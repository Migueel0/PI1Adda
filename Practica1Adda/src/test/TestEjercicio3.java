...
public class TestEjercicio3 {
	...
	public static void main(String [] args) {
		...
		Integer i =1;
		while(i<=3) {
			List<LineaFichero> fichero1 = ParseoFicheroEj3.listaDeFichero("Ficheros/PI1Ej3DatosEntrada" + i + "A.txt");
			List<LineaFichero> fichero2 = ParseoFicheroEj3.listaDeFichero("Ficheros/PI1Ej3DatosEntrada" + i + "B.txt");
